...
These concepts are formalized in the international standard \textit{Geographic information — Data quality} (ISO~19157-1:2023), which defines a structured framework for describing and documenting geospatial data quality \citep{ISO19157-1:2023}. The standard specifies five core quality elements: completeness, logical consistency, positional accuracy, temporal quality, and thematic quality. For building-footprint data, these dimensions are closely related to practical questions such as whether buildings are missing, spatially displaced, geometrically simplified, temporally outdated, or unsuitable for a specific mapping task. Related work often uses slightly different terminology. For example, \citep{Vieira_dataqualityindicators} and \cite{dataqualityinEarthobservation} refer to completeness, logical consistency, positional accuracy, temporal accuracy, and attribute accuracy, while also emphasizing the importance of lineage or provenance as an additional quality indicator.
...
building presence assessment,
and coordinate or point generation.
