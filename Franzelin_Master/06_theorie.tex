...
A further limitation for building-footprint refinement is that SAM can only segment visual evidence present in the image; when roofs are partly covered by trees, shadows, or other objects, the hidden footprint geometry cannot be inferred reliably without additional assumptions or adapted methods for occluded building segmentation \citep{tai2025segment}.
