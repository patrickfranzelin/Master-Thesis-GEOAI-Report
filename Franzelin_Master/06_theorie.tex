...
\caption{Schematic illustration of tokenization and embedding lookup. Input text is divided into tokens, mapped to vocabulary IDs, and converted into dense vector embeddings used as input to the transformer encoder.} \label{fig:tokenization_embedding}
\end{figure}
...
\caption{Schematic illustration of the foundation model paradigm. A model pretrained on large-scale heterogeneous data can be adapted to specific downstream tasks through fine-tuning, zero-shot learning, few-shot learning, or prompting.}
