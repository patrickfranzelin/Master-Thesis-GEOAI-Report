...
Over the past decades, many %TODO need to cite more references to support your claim of "many different methods"
different methods have been proposed \citep{ZHENG_Buildingdamage}, yet no approach has achieved 100 percent accuracy \citep{rastogi2022automatic}, largely due to the vast diversity of building shapes, materials, and architectural concepts.
%TODO need citations to support this, otw, in my opinion, proper reference data collection is the main obstacle
...
%TODO:need to explain why this proposed 2-step approach is necessary: what is the motivations, e.g. explain potential benefits compare to existing methods
