...
\usepackage[
	pdftitle={Towards AI-Assisted Building Footprint Quality Assessment in the Global South Using Vision and Multimodal Foundation Models},
	pdfsubject={},
...
\usepackage[main=english,ngerman]{babel}	%Paket um deutsche Gramatik zu erkennen
...
\usepackage[main=english,ngerman]{babel}
\usepackage{booktabs}
\usepackage[round]{natbib} % Autor-Jahr-Zitate ohne Nummerierung
\bibliographystyle{apalike-doi} % plainnat ist mit natbib author-year kompatibel
\usepackage{subcaption}
\usepackage{doi} % Paket für DOI-Unterstützung in Bibliographie
...
\addcontentsline{toc}{chapter}{List of Figures}	%Verzeichnis im Inhaltsverzeichnis hinzufügen (erzwingen)	
...
% ============= Glossary einbinden ============= 
%\include{myglossary}		%Wenn man ein auf Acronymen basierendes Verzeichniss haben möchte
...
\Author{Jean Patrick Franzelin}
\include{07_Untersuchungsgebiet}
...
% ============= Appendix einbinden ============= 
\include{appendix}
\include{12_ai_declaration}
% The signed/scanned personal declaration must be the final page of the submission PDF.
