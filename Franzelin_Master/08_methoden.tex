...
In the second stage, a SAM-based segmentation component is applied to generate candidate corrections for buildings identified as potentially improvable. Unlike the MLLM, the segmentation model excels at precise geometric delineation but lacks higher-level reasoning and contextual understanding. Therefore, the MLLM not only supports assessment but also generates spatial prompts that guide the segmentation process.
