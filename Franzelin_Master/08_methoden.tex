...
The contrast metrics were computed on the RGB patch extracted for the building. First, luminance was calculated from the RGB values as

\[
Y = 0.2126R + 0.7152G + 0.0722B .
\]

For each building, the mean luminance inside the building mask and inside the surrounding mask was calculated. The absolute luminance difference was then used as the main contrast measure. In addition, Michelson contrast was calculated as

\[
C_M = \frac{|Y_\mathrm{building} - Y_\mathrm{surrounding}|}{Y_\mathrm{building} + Y_\mathrm{surrounding}},
\]
