...
For evalution and espacialy for discussion i ran a methodology to analyse the contrast and rgb stretch of the five study areas, where i used to differnet methods, once i took all houses that wehere labeld perfect after the code run and than i compared the mask inside the polygon with a ring of xx meters around the house, the second approach was to label by hand 25 pictures - 5 per study area where i placed points approxamtely xx inside the polygon and xx outside on the surrounding ground avoiding nearby houses.
